...
<body>
 <!--div class="main">
<div class="logo">
<img src="C:\Users\TAS\Desktop\MNAC\Login_v4\mnac_logo.png">
</div-->
	<div class="limiter">
...
<img src="C:\Users\TAS\Desktop\MNAC\Login_v4\mnac_logo.png" align = "left" class = "topleft">
			...
			<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
				<form class="login100-form validate-form" action="insert.php" method="POST">
					...
					<div class="wrap-input100 validate-input m-b-23" data-validate = "Userame is required">
					...
					<div class="wrap-input100 validate-input m-b-23" data-validate="Password is required">
						...
						<input class="input100" type="password" name="pass1" placeholder="Re-type your Password">
						<!--span class="focus-input100" data-symbol="&#xf190;"></span-->
					</div>
